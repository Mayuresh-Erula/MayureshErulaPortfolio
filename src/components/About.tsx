  ...
  const education = [
    {
      ...
      description: 'Specialized in modern web frameworks, API design, state management, and the integration of AI models into full-stack application workflows.',
            ...
            <div className="relative border-l-2 border-obsidian-800 ml-4 sm:ml-6 pl-6 sm:pl-8 space-y-12">
              {education.map((edu, index) => (
                ...
                >
                  ...
                  <div className="absolute -left-[45px] sm:-left-[53px] top-0 w-10 h-10 rounded-xl bg-obsidian-900 border-2 border-obsidian-800 flex items-center justify-center group-hover:border-cyan-glow group-hover:scale-110 transition-all duration-300 shadow-md">
                    {edu.icon}
                  </div>
