              ...
              <div className="glass-panel p-8 rounded-2xl border border-obsidian-800 shadow-xl">
                ...
                <div className="flex gap-4">
                  <a
                    ...
                    className="flex-grow flex items-center justify-center gap-2 py-3 rounded-xl bg-obsidian-900 border border-obsidian-800 text-gray-400 hover:text-cyan-glow hover:border-cyan-glow/30 transition-all duration-300 shadow-sm"
                  >
            ...
            <div className="glass-panel p-8 rounded-2xl border border-obsidian-800 shadow-xl h-full">
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <button
                  ...
                  className="w-full flex items-center justify-center gap-2 py-4 rounded-xl bg-gradient-to-r from-cyan-glow to-violet-glow text-obsidian-950 font-bold font-display shadow-lg hover:shadow-cyan-500/20 hover:scale-[1.01] transition-all duration-300 disabled:opacity-50 cursor-pointer"
                >
                  {status === 'sending' ? (
                    'Sending...'
                  ) : (
